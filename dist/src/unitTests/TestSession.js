...
const Session_1 = __importDefault(require("../BattleManager/Session"));
const generatorHero_1 = __importDefault(require("../BattleManager/generators/generatorHero"));
const generatorEnemies_1 = __importDefault(require("../BattleManager/generators/generatorEnemies"));
